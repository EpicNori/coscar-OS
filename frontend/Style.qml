...
QtObject {
    ...
    // Glass dashboard tokens. These are intentionally independent from the
    // legacy theme palette so the home surface can keep a calm, readable
    // visual system while users continue to use the existing theme picker.
    readonly property string glassBackgroundImage: "./assets/glass-dashboard-bg.png"
    readonly property color glassPanel: "#7A173348"
    readonly property color glassPanelStrong: "#A8234A5D"
    readonly property color glassPanelSoft: "#4D8CA8B8"
    readonly property color glassBorder: "#66E7F4FA"
    readonly property color glassDivider: "#4DE8F2F7"
    readonly property color glassText: "#F7FBFF"
    readonly property color glassMutedText: "#C7D8E2"
    readonly property color glassAccent: "#4DE0F3"
    readonly property color glassSuccess: "#9BE878"
    readonly property int glassRadius: 24
    readonly property int glassSmallRadius: 16
